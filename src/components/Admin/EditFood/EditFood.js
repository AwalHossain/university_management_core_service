...
const EditFood = () => {
  ...
  useEffect(() => {
    fetch(`https://boiling-ocean-57836.herokuapp.com/api/single/${id}`)
      .then((res) => res.json())
  ...
  const onSubmit = (data) => {
    ...
    setInfo(data);
    fetch(
      `https://boiling-ocean-57836.herokuapp.com/api/foodItem/update/${id}`,
      {
        method: "PUT",
        headers: {
